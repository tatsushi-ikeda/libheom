...
class linalg_engine_base {
 public:
  ...
  linalg_engine_base(linalg_engine_base *parent) : children(nullptr), n_children(0),
      n_threads_old(0)
  {
    CALL_TRACE();
  }
...
{
  CALL_TRACE();
  return errnrm1_impl<n_level_c, dtype_real, linalg_engine>::func(engine_obj,
                                                                  e,
                                                                  x_1,
                                                                  x_2,
                                                                  atol,
...
{
  CALL_TRACE();
  axpym_impl<n_level_c, dtype, matrix_base, order, linalg_engine>::func(engine_obj, a, x, y,
                                                                        n_level);
}
...
{
  CALL_TRACE();
  gemm_impl<n_level_c, dtype, matrix_base, order, linalg_engine>::func(engine_obj,
                                                                       alpha,
                                                                       A,
                                                                       B,
                                                                       beta,
...
{
  CALL_TRACE();
  gemv_impl<n_level_c, dtype, matrix_base, order, linalg_engine>::func(engine_obj,
                                                                       alpha,
                                                                       A,
                                                                       x,
                                                                       beta,
...
{
  CALL_TRACE();
  gevm_impl<n_level_c, dtype, matrix_base, order, linalg_engine>::func(engine_obj,
                                                                       alpha,
                                                                       x,
                                                                       A,
                                                                       beta,
...
{
  CALL_TRACE();
  utf_impl<n_level_c, dtype, matrix_base, order, linalg_engine>::func(engine_obj, A, v, A_v,
                                                                      n_level);
}
...
{
  CALL_TRACE();
  utb_impl<n_level_c, dtype, matrix_base, order, linalg_engine>::func(engine_obj, A_v, v, A,
                                                                      n_level);
}
...
{
  CALL_TRACE();
  kron_x_1_impl<n_level_c, dtype, matrix_base, order, order_kron, linalg_engine>::func(obj,
                                                                                       alpha,
                                                                                       x,
                                                                                       beta,
                                                                                       y,
...
{
  CALL_TRACE();
  kron_1_x_T_impl<n_level_c, dtype, matrix_base, order, order_kron, linalg_engine>::func(obj,
                                                                                         alpha,
                                                                                         x,
                                                                                         beta,
                                                                                         y,
...
#endif // ifndef LIBHEOM_LINALG_ENGINE_H
