...
class redfield_hilb : public redfield<dtype, order, linalg_engine> {
 public:
  ...
  virtual void set_param(linalg_engine *obj)
  {
    ...
    this->impl.Lambda.reset    (new matrix_base<n_level_c, dtype, order,
                                                linalg_engine>[this->n_noise]);
    this->impl.Lambda_dgr.reset(new matrix_base<n_level_c, dtype, order,
                                                linalg_engine>[this->n_noise]);
...
#endif // ifndef LIBHEOM_REDFIELD_HILB_H
